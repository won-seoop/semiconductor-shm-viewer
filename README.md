...
![Problem](semiconductor_shm_viewer/web/process/problem.png)
...
![Solve](semiconductor_shm_viewer/web/process/solve.png)
...
![Shared Memory Read Logic](semiconductor_shm_viewer/web/process/shared_memory_read_logic.png)
...
![Common Data Parsing Logic](semiconductor_shm_viewer/web/process/common_data_parsing_logic.png)
...
![Guide 1](semiconductor_shm_viewer/web/guide/1.png)
...
![Guide 2](semiconductor_shm_viewer/web/guide/2.png)

TEST 탭을 선택하면 사이드바 하단에 CSV 직접 업로드 섹션이 활성화됩니다.

### Step 3 — 메타데이터 CSV 업로드

![Guide 3](semiconductor_shm_viewer/web/guide/3.png)
...
![Guide 4](semiconductor_shm_viewer/web/guide/4.png)
...
![Guide 5](semiconductor_shm_viewer/web/guide/5.png)
